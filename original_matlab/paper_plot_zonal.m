...
set(lgd,'Location','southwest');     % 固定位置
...
% === 导出 ===
if info == 1
    exportgraphics(gcf,['zonal_',CaseName,'withinfo','.png'],'Resolution',600); % 高分辨率导出
else
    exportgraphics(gcf,['zonal_',CaseName,'.png'],'Resolution',600); % 高分辨率导出
end
